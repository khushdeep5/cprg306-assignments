...
export default function NewItem() {
  ...
  return (
        ...
        <div className="w-90 font bg-white text-black rounded-lg px-5 py-5 justify-self-center justify-items-start m-10">
          <div>
        ...
        <input
          ...
          className=" text-black block w-75 h-10 bg-white rounded-sm px-5 py-5 border border-gray-300 mb-2"
        />
          </div>
          <div>
          ...
          <p className="py-0.5 text-gray-500 mb-1.5 text-sm">Allowed range: 1–20</p>
      ...
      >
        ...
        className="bg-green-500 text-white font-bold rounded px-4 py-2 hover:bg-green-600 "> Submit
